  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-black">Add Staff Member</h1>
          <p className="text-slate-700">Add a new team member to your staff</p>
        </div>
      </div>

      <Card className="bg-white border-slate-200">
        <CardHeader>
          <CardTitle className="text-black">New Staff Member</CardTitle>
